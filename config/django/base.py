...
SECRET_KEY = env.str('SECRET_KEY', default='django-insecure-q2m%6pach+q1u7+8re2@_u88vu&d=zk1zc0wyv%sjavy^88&h+')
...
DATABASES = {
    "default": env.db("DATABASE_URL", default='postgresql://postgres:alex@123@localhost:5432/annuaire_did'),
}
