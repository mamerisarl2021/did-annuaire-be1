...
class APIKey(BaseModel):
    ...
    created_by = models.ForeignKey('users.User', on_delete=models.SET_NULL, null=True, related_name='created_api_keys')
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(fields=["key_prefix"], name="api_key_prefix_unique"),
