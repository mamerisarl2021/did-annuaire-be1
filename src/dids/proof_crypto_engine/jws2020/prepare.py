...
def prepare_signing_request(document: dict, kid: str, alg: str, nonce: str | None = None) -> dict[str, str]:
    """
    ...
    protected_b64 = _b64u(json.dumps(header, separators=(",", ":"), ensure_ascii=False).encode("utf-8"))
