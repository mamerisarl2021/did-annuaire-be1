    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('environment', models.CharField(choices=[('DRAFT', 'Draft'), ('PREPROD', 'Pré-production'), ('PROD', 'Production')], default='DRAFT', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(db_index=True, default=django.utils.timezone.now)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('environment', models.CharField(choices=[('PREPROD', 'Pre-production'), ('PROD', 'Production')], max_length=10)),
