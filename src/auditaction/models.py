...
class AuditAction(models.TextChoices):
    ...
    ORGANIZATION_TOGGLED_ACTIVATION = 'ORGANIZATION_TOGGLED_ACTIVATION', 'Organization status toggled'
...
class AuditLog(BaseModel):
    ...
    organization = models.ForeignKey('organizations.Organization', on_delete=models.SET_NULL, null=True, blank=True,
                                     related_name='audit_actions')
    # Quoi
    category = models.CharField(max_length=32, choices=AuditCategory.choices, default=AuditCategory.SYSTEM)
    ...
    target_id = models.CharField(max_length=255, blank=True, null=True, help_text="ID de la ressource affectée")

    # Contexte
    details = models.JSONField(default=dict, blank=True, help_text="Informations contextuelles supplémentaires")
